        ...
        <Col className='col-md-6'>
            ...
            <article className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-3" style={{'background-color':`${value100910}`,'border':`${value10057}`}} onClick={() => {
				...
				setLgShow2('SEND')
                    ...
                    <img src={require(`./images/litecoin.png`)}/>
                    <h3 className='b mt-2 text-center text-black'>YOUasdf SEND</h3>
                    <p className='b text-black text-center tc'>LTc</p>
                </article>
                </Col>
                ...
                <img src={require(`./images/bitcoin.png`)}/>
                <h3 className='b text-black fs-5 mt-2'>YOU RECEIVE</h3>
                <p className='b text-black fs-6' >BTC</p>
                </article>
                </Col>
            </Row>
