...
const LTC_BTC_HI= ({reverse,value2,change1,value3,value4,value5,value6,value7,value10,value11,changetodoge,changetoltc,changetobtc,changetodoge4,changetoltc4,changetobtc4,event1,value500,from1,to1,value71,value72,value73,value74,value75,value76,call,value1500,value1006,backtohome,changetoxmr,value738,changetoxmr2,value739,value740,value741,changetobnb1,changetobnb2,value750,value751,changetobch1,changetobch2,changetotrx1,value760,value761,value7610,value501,value10070,value1600,changetorose1,event105,changetorose2,changetodash1,send2,first56,first66,changetoavax1,changetoada1,changetovet1,changetoxtz1,value81,changetoeth1,value859,changetosol1,theme,value8591,changetoetc1,changetodark,value1008,value10091,value10092,bg1,value10081,value10082,value10083,changetolight,value10085,logo_value,value10087,value10088,value100910,value10059,value100912,value10057,value100915,changetologin,changetosignup,orderid1,value0200,value0201,value0789,value_bg})=>{
    ...
    return(
        ...
        <Col className='col-md-3 d-flex justify-content-center align-items-center flex-row' > <a className="btn45 mt-1 me-2 f6 grow no-underline ba bw1 ph2 pv1 mb1 dib b text-white pt-1" onClick={orderid1}>खोजें</a>
        <p className='b text-white text-center fs-6  justify-content-end  align-items-center mt-2' style={{'display':`${value0200}`}} >कृप्या अपनी आर्डर आईडी दर्ज करें</p>
        <input id="name" placeholder='आपकी आर्डर आईडी' onChange={value0201} className="b input-reset ba b--black-20 pt-2 pb-2 ps-2 db w-60" type="text" aria-describedby="name-desc" /> </Col>
        ...
        <Container fluid>
                        ...
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className=' b text-white d-flex justify-content-center align-items-center navlink'>वॉलेट <img src={require(`./images/green.png`)}   className='ms-2' width={'17px'}/>
                        <span className="b fs-6 text-white d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >कार्यरत</span>
                        </Nav.Link>
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className='b text-white  d-flex justify-content-center align-items-center navlink'>सिस्टम स्टेटस <img src={require(`./images/green.png`)} className='ms-2' width={'17px'}/>
                        <span className="b text-white fs-6 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >कार्यरत</span></Nav.Link>
                            ...
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://localhost:3000/jp/ltc/btc">日本語 <img src={require(`./images/japan.png`)} className='flag2' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://localhost:3000/cn/ltc/btc">中文 <img src={require(`./images/china.png`)} className='flag3' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://localhost:3000/ru/ltc/btc">руский <img src={require(`./images/russia.png`)} className='flag4' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://localhost:3000/en/ltc/btc">English </Dropdown.Item>
                            </Dropdown.Menu>
        ...
        <Col className='col-md-6'>
            ...
            <Row className='tc text-center justify-content-center align-items-center'>
                ...
                <Button className={'btn1 b shadow-3'} style={{'background-color':`${value100912}`, 'color':`${value10059}`, 'border':`${value10057}`} } >विनमय दर</Button>
                </Col>
            ...
            <article className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-3" style={{'background-color':`${value100910}`,'border':`${value10057}`}} onClick={() => {
				...
				setLgShow2('SEND')
                    ...
                    <h3 className='b mt-2 text-center fs-5' style={{'color':`${value10059}`}}>आप भेजेंगे</h3>
                    <p className='b text-center tc fs-6' style={{'color':`${value10059}`}}>LTC (Litecoin)</p>
                </article>
                </Col>
                ...
                <h3 className='b fs-5 mt-2' style={{'color':`${value10059}`}} >आप प्राप्त करेंगें</h3>
            ...
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p className='b para258' style={{'color':`${value10059}`}}>वह राशि दर्ज करें जिसे आप भेजेंगे </p>
            ...
            <p className='b text-red text-center tc para3000' style={{'display':`${value1600}`}} >कृप्या एक वैध राशि दर्ज करें</p>
            </Col>
            </Row>
            
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p style={{'color':`${value10059}`}} className='b para10'>प्राप्त करनें का पता (एडरस)</p>
                </Col>
            </Row>
            ...
            <Row className='mt-0'>
            <Col className='col-md-12 text-black'>
            <input id="name" className="input_address b  text-center tc input-reset ba b--black-20 pa2 mb2 db w-100" type="text" aria-describedby="name-desc" placeholder={`आपका  ${value4}  एडरस (पता) `} onChange={event1} onFocus={value1006} />
            <p className='b text-red text-center tc para3000' style={{'display':`${value500}`}} >Please Enter a Valid {value4} address</p>
            <p className='b text-red text-center tc para3000' style={{'display':`${value1500}`}} >कृप्या एक पता दर्ज करें</p>
                </Col>
            </Row>

            <Row className='mt-3'>
                <Col className='col-md-12 text-black'>
                <Button className='btn2 b shadow-3' style={{'background-color':`${value100910}`,'border':`${value10057}`,'color':`${value10059}`}}  onClick={call}>
विनिमय करें</Button>
                </Col>
            </Row>
      ...
      <h3 className='b tc text-black'>YOU {lgShow2} </h3>
       ...
       <ul>
        ...
        <img src={require(`./images/r1.png`)} width="500px" />
             ...
             <Row>
             <h1 className='b text-white tc text-center'>किसी भी  कृप्टो को स्वैप करें</h1>
             </Row>
            ...
            <h2 className='tc b fs-2 mt-4 text-center'>कृप्टो को कैसें विनिमय करें</h2>
            <p className='b fs-4 tc text-cente br'>इंदसबिट पर कृप्टो का विनिमय करना बिल्कुल सरल व आसान हैं</p>
            <p className='b fs-4 tc text-center'>चार चरणों का पालन करें</p>
            ...
            <h6 className='b fs-6'>कृप्टो को चुनें जिसका आप विनिमय करना चाहते हैं </h6>
            </Col>
            ...
            <h6 className='b fs-6'>अपना कृप्टो पता दर्ज करें</h6>
            </Col>
            <Col className='col-md-3 col-12 mt-3 mb-3'>
            ...
            <h6 className='b fs-6'>और विनिमय करें</h6>
            </Col>
            <Col className='col-md-3 col-12 mt-3 mb-3'>
  ...
  <path d="M5.5 13v1.25c0 .138.112.25.25.25h1a.25.25 0 0 0 .25-.25V13h.5v1.25c0 .138.112.25.25.25h1a.25.25 0 0 0 .25-.25V13h.084c1.992 0 3.416-1.033 3.416-2.82 0-1.502-1.007-2.323-2.186-2.44v-.088c.97-.242 1.683-.974 1.683-2.19C11.997 3.93 10.847 3 9.092 3H9V1.75a.25.25 0 0 0-.25-.25h-1a.25.25 0 0 0-.25.25V3h-.573V1.75a.25.25 0 0 0-.25-.25H5.75a.25.25 0 0 0-.25.25V3l-1.998.011a.25.25 0 0 0-.25.25v.989c0 .137.11.25.248.25l.755-.005a.75.75 0 0 1 .745.75v5.505a.75.75 0 0 1-.75.75l-.748.011a.25.25 0 0 0-.25.25v1c0 .138.112.25.25.25L5.5 13zm1.427-8.513h1.719c.906 0 1.438.498 1.438 1.312 0 .871-.575 1.362-1.877 1.362h-1.28V4.487zm0 4.051h1.84c1.137 0 1.756.58 1.756 1.524 0 .953-.626 1.45-2.158 1.45H6.927V8.539z"/>
            ...
            <h6 className='b fs-6'>सेकंडो में अपना कृप्टो प्राप्त करें</h6>
            </Col>
            </Row>
            </Col>
            </Row>
