    ...
    return(
        ...
        <Container fluid>
                        ...
                        <span className="b text-white span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >Working</span></Nav.Link>
                            ...
                            <Dropdown.Item style={{'color':`${value10059}`}} href="http://indusbit.org/hi/ltc/btc">हिंदी <img src={require(`./images/india.jpg`)} className='flag1' width='30px' /> </Dropdown.Item>
        ...
        <Col className='col-md-6'>
            ...
            <p className='b para1' style={{'color':`${value10059}`}} >1 <span className='title1 ttu' >{from9}</span> = <span className='value'></span>{lgShow5} <span className='title2 ttu'>{to9}</span></p>
                </Col>
            </Row>

            <Row className='mt-3 justify-content-center align-items-center'>
            <Col className='col-md-5 col-12 text-center tc col10 col_special'>
            <article className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-4" style={{'background-color':`${value100910}`,'border':`${value10057}`}} onClick={() => {
				setLgShow(true)
				setLgShow2('SEND')
			}}>
                    <img src={require(`./images/${from9}.png`)} className='img_special1'/>
                    <h3 className='b mt-3 text-center fs-6' style={{'color':`${value10059}`}}>SEND</h3>
                    <p className='b text-center ttu tc fs-6' style={{'color':`${value10059}`}}>{from9}</p>
                </article>
                </Col>
                ...
                <img src={require(`./images/${to9}.png`)} className='img_special2' />
                <h3 className='b ttu mt-3 fs-6' style={{'color':`${value10059}`}} >RECEIVE</h3>
                <p className='b ttu' style={{'color':`${value10059}`}} >{to9}</p>
                </article>
                </Col>
            </Row>
            ...
            <input id="name2" style={{'color':`white`, 'background-color':`black`}} className="b input-reset ba b--black-20 pa3 mb2 db w-100 tc text-center" type="number" aria-describedby="name-desc" onFocus={value10070} onChange={event2} />
            <p className='ttu b text-red text-center tc para3000' style={{'display':`${value501}`}} >Min. {from9} Amount is 1.0.</p>
            ...
            <Row className='mt-0'>
            <Col className='col-md-12 text-black'>
            <input id="name" className="input_address b  text-center tc input-reset ba b--black-20 pa2 mb2 db w-100" type="text" aria-describedby="name-desc" placeholder={`Your ${to9} Address`} onChange={event1} onFocus={value1006} />
      ...
      <h3 className='b tc text-black'>YOU {lgShow2} </h3>
        ...
        <Modal.Body >
            <Row className='justify-content-center align-items-center'>
       <ul>
          <li><Link to="/en/ltc/doge">asdf</Link></li>        
        </ul>
            </Row>
